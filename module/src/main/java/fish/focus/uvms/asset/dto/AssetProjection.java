...
public class AssetProjection {
    ...
    private UnitTonnage grossTonnageUnit;
    ...
    private List<UUID> mobileTerminalIds;
    private String comment;
    private Long nationalId;
    private Boolean parked;

    public AssetProjection() {
    }

    public AssetProjection(UUID id, UUID historyId, Boolean ircsIndicator, Boolean ersIndicator, Boolean aisIndicator,
            Boolean vmsIndicator, String hullMaterial, Instant commissionDate, String constructionYear,
            String constructionPlace, Instant updateTime, String source, String vesselType, Instant vesselDateOfEntry,
            String cfr, String imo, String ircs, String mmsi, String iccat, String uvi, String gfcm, Boolean active,
            String flagStateCode, String eventCode, String name, String externalMarking, Boolean agentIsAlsoOwner,
            Double lengthOverAll, Double lengthBetweenPerpendiculars, Double safteyGrossTonnage, Double otherTonnage,
            Double grossTonnage, UnitTonnage grossTonnageUnit, String portOfRegistration, Double powerOfAuxEngine,
            Double powerOfMainEngine, Boolean hasLicence, String licenceType, String mainFishingGearCode,
            String subFishingGearCode, String gearFishingType, String ownerName, Boolean hasVms, String ownerAddress,
            String assetAgentAddress, String countryOfImportOrExport, String typeOfExport,
            Instant administrativeDecisionDate, String segment, String segmentOfAdministrativeDecision,
            String publicAid, String registrationNumber, String updatedBy, String prodOrgCode, String prodOrgName,
            UUID mobileTerminalId, String comment, Long nationalId, Boolean parked) {
        super();
        this.id = id;
        ...
        if (mobileTerminalId != null) {
            this.mobileTerminalIds = new ArrayList<>();
            this.mobileTerminalIds.add(mobileTerminalId);
        }
    ...
    public List<UUID> getMobileTerminalIds() {
        return mobileTerminalIds;
    }
    public void setMobileTerminalIds(List<UUID> mobileTerminalIds) {
