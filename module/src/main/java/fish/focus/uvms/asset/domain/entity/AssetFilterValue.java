...
import static fish.focus.uvms.asset.domain.entity.AssetFilterValue.ASSETFILTER_RETRIEVE_VALUES_FOR_QUERY;
import static fish.focus.uvms.asset.domain.entity.AssetFilterValue.ASSETFILTER_VALUE_CLEAR;
import static fish.focus.uvms.asset.domain.entity.AssetFilterValue.ASSETFILTER_VALUE_FIND_ALL;
import static fish.focus.uvms.asset.domain.entity.AssetFilterValue.ASSETFILTER_VALUE_GETBYID;
