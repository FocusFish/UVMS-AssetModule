...
import fish.focus.schema.mobileterminal.config.v1.CapabilityConfiguration;
import fish.focus.schema.mobileterminal.config.v1.ConfigList;
import fish.focus.schema.mobileterminal.config.v1.TerminalSystemConfiguration;
...
import fish.focus.uvms.mobileterminal.mapper.ServiceToPluginMapper;
